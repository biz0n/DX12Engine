...
namespace Engine::KeyCode
{
    enum Key
    {
        ...
        HanguelMode         = 0x15, //IME Hanguel mode (maintained for compatibility; use VK_HANGUL)
        ...
        IMEOff              = 0x1A, //IME Off
        Escape              = 0x1B, //ESC key
        IMEConvert          = 0x1C, //IME convert
        IMENonConvert       = 0x1D, //IME nonconvert
        IMEAccept           = 0x1E, //IME accept
        IMEModeChange       = 0x1F, //IME mode change request
        Space               = 0x20, //SPACEBAR
