...
{
    DescriptorAllocator::DescriptorAllocator(ID3D12Device* device, DescriptorAllocatorConfig heapSizes) :
        mDevice { device },
        mRTHeap 
        {
            device, 
    ...
    Descriptor DescriptorAllocator::AllocateRTDescriptor(ID3D12Resource* resource, Index heapIndex, uint32 mipSlice)
    {
    ...
    Descriptor DescriptorAllocator::AllocateDSDescriptor(ID3D12Resource* resource, Index heapIndex, uint32 mipSlice)
    {
        auto resDesc = resource->GetDesc();
    ...
    Descriptor DescriptorAllocator::AllocateSRDescriptor(ID3D12Resource* resource, Index heapIndex, uint32 strideSize)
    {
        auto resDesc = resource->GetDesc();
