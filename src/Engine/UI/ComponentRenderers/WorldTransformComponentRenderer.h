...
{
    static dx::XMFLOAT4X4 EditTransform(const Scene::Components::CameraComponent& camera, dx::XMFLOAT4X4& matrix, const dx::XMMATRIX& parentWorldTransform)
    {
    ...
    template <>
    static void RenderComponent<Scene::Components::WorldTransformComponent>(
        entt::registry& registry, 
        entt::entity entity, 
        Scene::Components::WorldTransformComponent& component, 
